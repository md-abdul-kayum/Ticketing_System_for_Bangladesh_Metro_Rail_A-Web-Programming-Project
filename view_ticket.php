<?php 
 ...
 {  
      ...
      {   
           $output .= ' 
                    <div class="col-lg-5">
						<img src="metro6.jpg" alt="Train image"  height="400px" width="400px">
                    </div>	
		            ...
		            <div class="col-lg-5">
						...
						<p class="pp">'.$row["BusinessClassFare"].' BDT</p>
						<h5>Standard Class Fare:</h5>
						<p class="pp">'.$row["StandardClassFare"].' BDT</p>
						<h5>Economical Class Fare:</h5>
						<p class="pp">'.$row["EconomicalClassFare"].' BDT</p>
                    </div>
...
<html>
    <head>
        <title>Bangladesh Metro Rail | Booking_Record</title>
...
<svg id="definition" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><symbol id="required" viewbox="0 0 128 128"><g><path d="M110.1,16.4L75.8,56.8l0.3,1l50.6-10.2v32.2l-50.9-8.9l-0.3,1l34.7,39.1l-28.3,16.5L63.7,78.2L63,78.5   l-18.5,49L17.2,111l34.1-39.8v-0.6l-50,9.2V47.6l49.3,9.9l0.3-0.6L17.2,16.7L45.5,0.5l17.8,48.7H64L82.1,0.5L110.1,16.4z"></path></g></symbol></defs></svg>
        ...
        <div class="myDiv">
            <h1 class="hh"><b>Book Your Ticket</b></h1>
            <form action="view_ticket.php" name="view_ticket" method="post"  onsubmit="return validate()">
                <div class="form-group">
                  ...
                  <input  type="text" id="name" name="name" autocomplete="off" class="form-control" id="name" autofocus placeholder="-- Enter Full Name --" >
                </div>
                <div class="form-group">
...
<div  id="Ticketreceipt" class="modal fade" role="dialog">
    ...
    <div class="modal-dialog modal-lg" role="content">
	    <div   class="modal-content">
		    <div  id="block1"  >
				<div class="modal-header" id="clr2">
					<h4 style="color:black;text-align: center;font-size: 30px;font-weight: bold"> Your Ticket </h4>
				...
				<div class="modal-body" id="clr">
					<div    class="container" style="background-color: #D6EAF8 ;border-radius: 10px;padding: 40px;">
						<div class="row">
							<div class="col-lg-6">
								<!-- <img src="dk_metro.png" alt="Train image"  height="150px" width="200px"> -->
                                <h1 style="text-align:center; font-family: Arial;"  ><img class="logo1" src="dk_metro.png" alt="" height="40px" width="60px"> <b><span style="color:#ff0000;">Bangladesh</span> Metro <span style="color: green;">Rail</span></b></h1>
							</div>
                            <br>
							<div class="col-lg-6" style="color:black;font-size: 25px;font-weight: bold">
                            <h3 style="font-family: segoe ui; color: green; text-align: center;" ><td ><?php echo $TrainName; ?></td></h3>
                            </div>
                    ...
                    <div style="text-align: right;">
                                ...
                                <td><?php echo $fare*$seat; ?></td>
                                <label for="number"><b> BDT</b></label>
						</div>
                        <div style="text-align:center; color: #800000; font-width:bold; font-family: century;"><label for=""><strong>Copyright ©2022 Md.Abdul Kaiyum</strong></label></div>					
					</div>
					
				</div>
			</div>
			<div class="modal-footer"  id="clr2">
            <button   style="background-color:FF0033 ; width:49.5%;height:5%;font-size: 15px;font-weight: bold; text-decoration: none; color:white;" TYPE="button" class="btn btn-warning ">  <a  href="passenger_home.php" > Close </a> </button>
