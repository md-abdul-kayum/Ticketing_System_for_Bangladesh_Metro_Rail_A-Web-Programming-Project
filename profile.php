...
$npw=$_POST['npw'];
		...
		{  
			echo "<script type='text/javascript'>alert('Username or Password did not Matched.');</script>";
		}
		else
		{  
...
<meta charset="UTF-8">
<html>
<title>Bangladesh Metro Rail | Profile</title>
...
input[type=submit]:hover {
  ...
  <a class="navbar-brand" href="#" ><img class="logo1" src="dk_metro.png" alt=""> <b><span class="sp3">Bangladesh</span> Metro <span class="sp1">Rail</span></b></a>
      ...
      <div class="container" style="background: transparent;background: rgba(72,168,179,0.5); ">
			<h1 style="background: white;" class="mainheading">Profile </h1>
			<hr>
