...
<meta charset="UTF-8">
<html>
<title>Bangladesh Metro Rail | Admin_Add_Route</title>
  ...
  vertical-align: top;
    ...
    <body data-spy="scroll" data-target="#navbarNav" data-offset="50">
		...
		<a class="navbar-brand" href="#" ><img class="logo1" src="dk_metro.png" alt=""> <b><span class="sp3">Bangladesh</span> Metro <span class="sp1">Rail</span></b></a>
		 ...
		 <br> <br>
	<form action="admin_add_route.php" name="admin_add_route" method="post" style="border:1px solid #ccc; padding: 15px;">
        <div class="container">
			<br/>
			...
			<hr>
			  ...
			  <div class="row">
				...
				<div class="col-75">
				  <input  class="form-control" type="number" id="businessclassfare" name="businessclassfare" placeholder="-- Enter Fare in BDT --">
				</div>
			  </div>
			  ...
			  <div class="row">
				...
				<div class="col-75">
				  <input  class="form-control" type="number" id="economicalclassfare" name="economicalclassfare" placeholder="-- Enter Fare in BDT --">
				</div>
			  </div>		
			  ...
			  <div class="row">
				...
				<div class="col-75">
				  <input   class="form-control" type="number" id="standardclassfare" name="standardclassfare" placeholder="-- Enter Fare in BDT --">
				</div>
			  </div>
